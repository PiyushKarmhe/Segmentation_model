...
def predict(ImagePathUplaoded): 
    ...
    print("Predicted Image : ",predicted_image_pil)
    ...
    predicted_image_pil = predicted_image_pil.convert('L')
    # predicted_image_pil.putpalette([x for rgb in cmap.colors for x in rgb])
    predicted_image_pil = ImageOps.colorize(predicted_image_pil, black="#00FF00", white="#FF00FF")
